...
use crate::git::BlockReason;
use crate::session::{Board, BoardPos, ProjectId, SessionId, SessionListItem};
...
pub struct BoardRenderOutput {
    ...
    pub heading_regions: Vec<(Rect, crate::backend::BackendId)>,
...
impl<'a> BoardWidget<'a> {
    ...
    fn render_sidebar(
        ...
        heading_regions: &mut Vec<(Rect, crate::backend::BackendId)>,
    ) {
    ...
    fn render_server_heading(
        &self,
        server: &crate::session::BoardServer,
        rect: Rect,
        y: u16,
        buf: &mut Buffer,
    ) {
    ...
    fn render_column(
        &self,
        col_idx: usize,
        column: &crate::session::BoardColumn,
        rect: Rect,
        buf: &mut Buffer,
        state: &mut BoardState,
        selected: Option<BoardPos>,
...
mod tests {
    use super::*;
    use crate::session::{BoardCard, BoardColumn, BoardProjectEntry, SessionStatus};
    use chrono::Utc;
    ...
    fn scrolled_column_offsets_hit_regions_into_the_viewport() {
        ...
        let board = Board {
            ...
            columns: vec![column(crate::session::IN_PROGRESS, None, cards)],
        };
    ...
    fn separators_drawn_in_border_colour_at_layout_positions() {
        ...
        let board = Board {
            ...
            projects: vec![entry(pid, "P", 1)],
            columns: vec![
                column(crate::session::IN_PROGRESS, None, vec![]),
                column("Open", None, vec![]),
            ],
        };
    ...
    fn stack_base_and_child_agree_on_button_visibility_at_borderline_width() {
        ...
        let sidebar_and_sep = crate::tui::widgets::board::layout::SIDEBAR_WIDTH + 1;
