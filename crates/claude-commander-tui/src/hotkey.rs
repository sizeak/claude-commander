...
use claude_commander_core::config::keybindings::{BindableAction, KeyBinding, KeyBindings};
...
mod tests {
    use super::*;
    use claude_commander_core::config::keybindings::KeyBindings;
