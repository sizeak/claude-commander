...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 792245421;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        22 => wire__crate__api__review__fetch_blob_impl(port, ptr, rust_vec_len, data_len),
        23 => wire__crate__api__simple__get_session_detail_impl(port, ptr, rust_vec_len, data_len),
        24 => wire__crate__api__simple__github_repos_impl(port, ptr, rust_vec_len, data_len),
        25 => wire__crate__api__simple__health_impl(port, ptr, rust_vec_len, data_len),
        26 => wire__crate__api__simple__health_tmux_impl(port, ptr, rust_vec_len, data_len),
        27 => wire__crate__api__simple__image_max_bytes_impl(port, ptr, rust_vec_len, data_len),
        28 => wire__crate__api__simple__init_app_impl(port, ptr, rust_vec_len, data_len),
        29 => wire__crate__api__simple__kill_session_impl(port, ptr, rust_vec_len, data_len),
        30 => wire__crate__api__simple__list_branches_impl(port, ptr, rust_vec_len, data_len),
        31 => wire__crate__api__review__list_comments_impl(port, ptr, rust_vec_len, data_len),
        32 => wire__crate__api__simple__list_sessions_impl(port, ptr, rust_vec_len, data_len),
        33 => wire__crate__api__simple__mark_read_impl(port, ptr, rust_vec_len, data_len),
        34 => wire__crate__api__simple__mark_unread_impl(port, ptr, rust_vec_len, data_len),
        35 => wire__crate__api__review__open_review_impl(port, ptr, rust_vec_len, data_len),
        36 => wire__crate__api__simple__paste_image_impl(port, ptr, rust_vec_len, data_len),
        37 => wire__crate__api__simple__pending_comment_sessions_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        38 => wire__crate__api__simple__project_preview_impl(port, ptr, rust_vec_len, data_len),
        39 => wire__crate__api__simple__push_stack_impl(port, ptr, rust_vec_len, data_len),
        40 => wire__crate__api__review__refresh_review_impl(port, ptr, rust_vec_len, data_len),
        41 => wire__crate__api__simple__remove_project_impl(port, ptr, rust_vec_len, data_len),
        42 => wire__crate__api__simple__rename_session_impl(port, ptr, rust_vec_len, data_len),
        43 => wire__crate__api__simple__request_pr_refresh_impl(port, ptr, rust_vec_len, data_len),
        44 => wire__crate__api__simple__restart_session_impl(port, ptr, rust_vec_len, data_len),
        45 => wire__crate__api__simple__scan_directory_impl(port, ptr, rust_vec_len, data_len),
        46 => wire__crate__api__simple__session_preview_impl(port, ptr, rust_vec_len, data_len),
        47 => wire__crate__api__simple__set_programs_impl(port, ptr, rust_vec_len, data_len),
        48 => wire__crate__api__simple__set_section_impl(port, ptr, rust_vec_len, data_len),
        49 => wire__crate__api__simple__start_clone_impl(port, ptr, rust_vec_len, data_len),
        50 => wire__crate__api__terminal__terminal_detach_impl(port, ptr, rust_vec_len, data_len),
        51 => wire__crate__api__terminal__terminal_resize_impl(port, ptr, rust_vec_len, data_len),
        52 => {
        ...
        54 => wire__crate__api__simple__toggle_keep_alive_impl(port, ptr, rust_vec_len, data_len),
        55 => wire__crate__api__simple__workspace_snapshot_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
